...
from db.seed import seed_admin, seed_permissions, TestSeed
from db.database import create_db_and_tables, engine, get_async_session
...
async def on_startup():
    if settings.TESTING:
        raise Exception('Please set TESTING=False in .env')
