...
export default function Home() {
  function onSubmit(e) {
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_PATH}/auth/register`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
      },
      body: new URLSearchParams(user), // Преобразуем объект в строку JSON
    })
  ...
  useEffect(() => {
    ...
    setInterval(() => {
      const newColor = `rgba(${Math.random() * 255}, ${
        Math.random() * 100 + 155
      }, ${Math.random() * 255}, 0.5)`;
        ...
        <form action='' onSubmit={onSubmit}>
          ...
          <div className='register-link'>
            <p>
              ...
              <a href='http://127.0.0.1:3000/'>Вход</a>
            </p>
          </div>
        </form>
      </div>
